...
public class DeleteChatRoomViewModel extends AndroidViewModel {

    private MutableLiveData<JSONObject> mChatRoom;

    public DeleteChatRoomViewModel(@NonNull Application application) {
        super(application);
    ...
    public void connectDeleteRoom(String chatID, final String jwt) {
