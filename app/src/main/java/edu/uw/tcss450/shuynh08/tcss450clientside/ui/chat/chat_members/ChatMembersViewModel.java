...
public class ChatMembersViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<JSONObject> mChatMember;

    public ChatMembersViewModel(@NonNull Application application) {
        super(application);
        mChatMember = new MutableLiveData<>();
        mChatMember.setValue(new JSONObject());
    }

    public void addResponseObserver(@NonNull LifecycleOwner owner,
                                    @NonNull Observer<? super JSONObject> observer){
        mChatMember.observe(owner, observer);
    }
    ...
    public void connectRemoveMember(String email, String chatID, final String jwt) {
